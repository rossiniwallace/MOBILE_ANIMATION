...
import { StyleSheet, Text, View, ImageBackground, StatusBar, TextInput, Animated, Dimensions, TouchableOpacity } from 'react-native';
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <ImageBackground source={require("./header.png")}
            style={styles.imageBackground}>

            <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 30 }}>Welcome Back</Text>
